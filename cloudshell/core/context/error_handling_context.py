...
class ErrorHandlingContext(object):
    ...
    def __exit__(self, exc_type, exc_value, exc_traceback):
        ...
        Should not be called explicitly. In case of exception during the block execution
        logs the error with debug severity and allows the same exception to be thrown
